...
- ✅ Git operations (add, checkout, commit, push)
- ✅ All GitHub CLI issue and PR commands
- ✅ All custom slash commands
- ❌ Denied: force push, hard reset
...
### Sandbox Workflow Pattern

1. Claude drafts content in `docs/sandbox/`
2. User reviews/edits sandbox file
3. User posts with `-F` flag or `$(cat ...)` pattern
