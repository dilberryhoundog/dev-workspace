...
At the start of each task, check for a CLAUDE.md file in the project's stylesheets/CSS directory. If it exists, read it once to understand the framework's styling conventions, naming patterns, and architecture. Use this context throughout your search but don't re-read it. If it doesn't exist, skip this step and proceed with the search.
